...
public class Loan {
    ...
    public Loan(long mobileNo, long accountNumber, long loanAccountNumber, String loanType, LocalDate loanDate,
            double loanAmt, double interestRate, int noofLoanMonths,
            int monthsRemain,
            Boolean act) {
        ...
        this.dueDate = loanDate.plusMonths(1).plusDays(5);
    ...
    public void setDueDate(LocalDate paidDate) {
        this.dueDate = paidDate;
    }
